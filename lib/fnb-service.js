...
function buildAlerts({ channels, pendingApprovals, pipeline, googleConfigured = true }) {
  const alerts = []
...
async function getOpsSnapshotInternal(context, locationId) {
  ...
  const alerts = buildAlerts({ channels, pendingApprovals, pipeline, googleConfigured })
